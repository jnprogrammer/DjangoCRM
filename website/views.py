...
def delete_record(request,pk):
    if request.user.is_authenticated:
        ...
        delete_it.delete()
        messages.success(request, f"Deleted Record #{pk}! ")
        return redirect('home')
    else:
        messages.success(request, "Log in first to do that ")
        return redirect('home')
...
def update_record(request,pk):
    if request.user.is_authenticated:
        ...
        if form.is_valid():
            form.save()
            messages.success(request, f"Record {pk} was Updated")
            return redirect('home')
